...
/** Enhanced ambient orbs for the main dashboard scroll area */
export default function DashboardAmbientBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      {/* Secondary gradient orb - left middle */}
      <motion.div
      ...
      {/* Success gradient orb - bottom left */}
      <motion.div
      ...
      {/* Warning gradient orb - top center */}
      <motion.div
